...
| `$2600-$26AB` | Runtime BSS | frame, input, camera, sprite shadow, player/stance, shot/bomb arc, objects, action hazards, Continue countdown, danger-rank, transition, respawn slicing and sound state |
| `$26AC-$3FFF` | Free main RAM | 6,484 bytes before VIC bank |
