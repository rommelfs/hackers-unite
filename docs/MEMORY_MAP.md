...
| `$2600-$26A9` | Runtime BSS | frame, input, camera, sprite shadow, player/stance, shot/bomb arc, objects, action hazards, Continue countdown, danger-rank, transition and sound state |
| `$26AA-$3FFF` | Free main RAM | 6,486 bytes before VIC bank |
...
| `$5755-$5FFF` | Free VIC-bank RAM | 2,219 bytes; no current VIC pointer targets this range |
